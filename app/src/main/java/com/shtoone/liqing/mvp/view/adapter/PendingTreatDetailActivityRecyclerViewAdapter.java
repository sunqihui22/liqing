 ...
 */
public class PendingTreatDetailActivityRecyclerViewAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private static final String TAG = PendingTreatDetailActivityRecyclerViewAdapter.class.getSimpleName();
    private Context context;
    private PendingTreatDetailRes itemsData;
    private Resources mResources;
    private List<SC_chaxunItem_xq_data> lists;

    public PendingTreatDetailActivityRecyclerViewAdapter(Context context, List<SC_chaxunItem_xq_data> lists) {
        super();
