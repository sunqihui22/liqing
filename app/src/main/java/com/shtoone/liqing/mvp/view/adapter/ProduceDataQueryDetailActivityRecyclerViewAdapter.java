 ...
 */
public class ProduceDataQueryDetailActivityRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = ProduceDataQueryDetailActivityRecyclerViewAdapter.class.getSimpleName();
    private Context context;
    private ProduceDataDetailRes itemsData;
    private Resources mResources;
    private List<SC_chaxunItem_xq_data> lists;

    public ProduceDataQueryDetailActivityRecyclerViewAdapter(Context context, List<SC_chaxunItem_xq_data> lists) {
        super();
