 ...
 */
public class MaterialUsageFragmentRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = MaterialUsageFragmentRecyclerViewAdapter.class.getSimpleName();
    private Context context;
    private List<SC_cailiaoyongliang> itemsData;
    private Resources mResources;

    public MaterialUsageFragmentRecyclerViewAdapter(Context context, List<SC_cailiaoyongliang> itemsData) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            mViewGroup.setBackgroundColor(position % 2 == 0 ? mResources.getColor(R.color.material_teal_50) : mResources.getColor(R.color.material_deepPurple_50));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ItemViewHolder holder = new ItemViewHolder(LayoutInflater.from(context).inflate(R.layout.item_recyclerview_material_usage_fragment, parent, false));
        return holder;
    }
